      ...
      <ul v-else class="list-inline mb-0">
        <li class="list-inline-item">
          ...
          <dropdown :title="user.name">
            <dropdown-item><a href="#" class="drop-item">新建文章</a></dropdown-item>
            <dropdown-item disabled><a href="#" class="drop-item">编辑资料</a></dropdown-item>
            <dropdown-item><a href="#" class="drop-item">退出登录</a></dropdown-item>
          </dropdown>
        </li>
      </ul>
  </nav>
